...
function SignUp() {
   ...
   const [check3, setCH3] = useState(false);
    ...
    // }
    const onCONTACT3Handler = (et) => {
        setCONTACT3(et.currentTarget.value);
    }
    ...
    const onSubmit = async function(e) {
        ...
        // const fullCONTACT = `${CONTACT}+${CONTACT2}+${CONTACT3}`;

        // 서버에 전송할 데이터 객체 생성
        const data = {
            input_ID: ID,
            input_PW: PW,
            input_CONTACT: CONTACT3,
            input_EMAIL: EMAIL,
        ...
        try {
            // 서버에 POST 요청
            e.preventDefault();
            const url = `http://localhost:8080/Project_Mall/SignUp.jsp?input_EMAIL=${EMAIL}&input_CONTACT=${CONTACT3}&input_ADDRESS=${ADDRESS}&input_ID=${ID}&input_PW=${PW}`;
            console.log(url);
    ...
    //     const data = axios.get(`http://localhost:8080/Project_Mall/SignUp.jsp?input_ID=${ID}&input_PW=${PW}&input_CONTACT=${CONTACT}&input_EMAIL=${EMAIL}&input_ADDRESS=${ADDRESS}`);
    //         data.then((res) => {
                ...
                <table className={style.Table}>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type='text' placeholder='아이디' onChange={onIDHandler} name='input_ID'></input> <span>영문자로 시작하고, 5~10 길이의 영문자와 숫자</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='password' placeholder='비밀번호'onChange={onPWHandler}name='input_PW'></input> <span>영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 7자~12자</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='password' placeholder='비밀번호'onChange={onPW2Handler} name='input_PW2'></input> 
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='text' placeholder='이메일' onChange={onEMAILHandler} name='input_EMAIL'></input>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type='text' placeholder='연락처' onChange={onCONTACT3Handler} maxLength={11} name='input_CONTACT'></input> <span> '-' 제외하고 숫자만 입력 </span>
